      ...
      dialog: JSON.stringify({
        ...
        elements: [
          ...
          },
          {
            ...
            type: 'select',
            name: 'type',
            placeholder: "'Incidents' are for an unexpected event; 'Problems' are the root cause of an incident.",
            options: [
          ...
          },
          {
            ...
            type: 'select',
            name: 'priority',
            placeholder: 'For emergencies, please contact support directly.',
            options: [
